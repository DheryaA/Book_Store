...
const AllOrders = () => {
    ...
    useEffect(() => {
        const fetch = async () => {
            const response = await axios.get(
                "https://book-store-8uzx.onrender.com/api/v1/get-all-orders",
                { headers }
            );
    ...
    const submitChanges = async (i) => {
        ...
        const response = await axios.put(
            `https://book-store-8uzx.onrender.com/api/v1/update-status/${id}`,
            Values,
            { headers }
        );
            ...
            {AllOrders && AllOrders.length > 0 && (
                ...
                <div className='h-[100%] p-0 md:p-4 text-zinc-100'>
                    ...
                    {AllOrders.map((items, i) => (
                        ...
                        hover:bg-zinc-900 hover:cursor-pointer transition-all duration-300'
                        >
                            <div className='w-[3%]'>
